...
If you follow the code, you'll notice that https://github.com/phoenixframework/phoenix/blob/v0.13.0/lib/phoenix/view.ex#L261:[render_many/2] and https://github.com/phoenixframework/phoenix/blob/v0.13.0/lib/phoenix/view.ex#L330:[render_one/2] call https://github.com/phoenixframework/phoenix/blob/v0.13.0/lib/phoenix/view.ex#L268:[render_many/3] and https://github.com/phoenixframework/phoenix/blob/v0.13.0/lib/phoenix/view.ex#L337:[render_one/3] respectively with an empty map
